...
std::tuple<at::Tensor, at::Tensor,at::Tensor,at::Tensor> enctc_loss_gpu_template(
    at::Tensor& log_probs, at::Tensor& targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t BLANK
);
