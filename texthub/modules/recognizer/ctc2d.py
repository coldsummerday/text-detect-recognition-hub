...
from ..builder import build_backbone,build_img_trans,build_sequence,build_head,build_neck



@RECOGNIZERS.register_module
class CTC2DRecognitionModel(nn.Module):
    def __init__(self,
                 backbone,
                 neck,
                 head,
                 pretrained = None,**kwargs):
        super(CTC2DRecognitionModel, self).__init__()
    ...
    def postprocess(self,data):
        mask,classify =data
        return self.head.postprocess(mask,classify)
